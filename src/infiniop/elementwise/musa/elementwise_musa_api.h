#ifndef __INFINIOP_ELEMENTWISE_MUSA_API_H__
#define __INFINIOP_ELEMENTWISE_MUSA_API_H__
...
/**
 * @brief Define the methods and info needed by MUSA to perform elementwise operation
 */
...
public:
     ...
     * @param stream       MUSA stream (opaque void*).
 ...
 */
#define CREATE_ELEMENTWISE_MUSA_DESCRIPTOR(HANDLE, DTYPE, OUT_DESC, INPUT_DESC_VEC)          \
                                                                                             \
    ...
    auto workspace_size = info.getMetaMemSize() + info.getInputSize() * sizeof(void *);      \
                                                                                             \
    auto device_impl_result = op::elementwise::musa::DeviceImpl::create(HANDLE->internal()); \
...
#endif // __INFINIOP_ELEMENTWISE_MUSA_API_H__
